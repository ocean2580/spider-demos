...
urllib.request.urlretrieve(url_page, '../res/down/baidu.html')

# img
url_img = "https://img0.baidu.com/it/u=775547737,2915979378&fm=253&fmt=auto&app=138&f=JPEG?w=400&h=304"
urllib.request.urlretrieve(url_img,'../res/down/girl.jpg')
...
urllib.request.urlretrieve(url_video,'../res/down/h.mp4')
